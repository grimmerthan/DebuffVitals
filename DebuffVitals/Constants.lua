...
DEFAULT_FREEP_EFFECTS =  {
    {"Common",      "Dazed",                                    1, 0, {"Dazed", "Hébétément"}},
    {"Common",      "Force Attack",                             1, 0},    
    {"Common",      "Recovering",                               0, 0},
    {"Common",      "Stunned",                                  1, 0, {"Stunned","Etourdissement"}},
    {"Common",      "Rooted",                                   1, 0, {"Rooted", "Immobilisé"}},
    ...
    {"Lore-master", "Ancient Craft",                            0, 0, {"Artisanat ancien", "Ancient Craft"}}, 
    {"Lore-master", "Benediction of the Raven",                 0, 0}, 
    {"Lore-master", "Fire-lore",                                1, 0, {"Connaissance du feu", "Fire%-lore"}}, 
    {"Lore-master", "Frost-lore",                               1, 0, {"Connaissance du froid", "Frost%-lore"}}, 
    ...
    {"Lore-master", "Sign of Power: Command",                   0, 0, {"Sign of Power: Command", "%sInjonction"}},    
    {"Lore-master", "Sign of Power: See all Ends",              0, 0, {"Sign of Power: See all Ends", "%la fin des choses"}},    
